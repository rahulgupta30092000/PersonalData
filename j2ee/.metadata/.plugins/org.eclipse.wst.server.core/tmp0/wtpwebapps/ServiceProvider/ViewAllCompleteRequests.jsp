...
String qr="select u.name as uname,u.email as uemail,u.address as userAddress ,datetime,bookstatus from serviceprovider s,user u,bookingprovider where providerEmail=s.email and userEmail=u.email and bookstatus='completed' and s.email=?";
...
if(rs.next()){
	...
	out.println("no complete tasks found");
}
con.close();
%> 
</div>
